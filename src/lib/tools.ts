...
export const TOOLS: Tool[] = [
  ...
  { slug: "duplicate", href: "/duplicate", name: "Duplicate Editions", description: "Editions you hold more than one of.", category: "collector", status: "ready" },
  { slug: "artist-follow", href: "/artist/follow", name: "Watched Artists Feed", description: "Latest creations from artists you've saved.", category: "collector", status: "ready" },
  ...
  { slug: "fxhash-floor", href: "/fxhash/floor", name: "fxhash Floor", description: "Cheapest active listings in a collection.", category: "fxhash", status: "ready" },
  ...
  { slug: "artist-sale", href: "/artist/sale", name: "Manage Listings", description: "Cancel your active listings in batches.", category: "artist", status: "ready" },
  ...
  { slug: "fans", href: "/fans", name: "Top Collectors", description: "Top collectors of an artist's work.", category: "artist", status: "ready" },
  { slug: "giveaway", href: "/giveaway", name: "Airdrop", description: "Send a token to many wallets at once.", category: "artist", status: "ready" },
  ...
  { slug: "swap-batch", href: "/swap/batch", name: "Bulk List", description: "List many tokens for sale on objkt v6.2 in one signing.", category: "artist", status: "ready" },
  { slug: "swap-reswap", href: "/swap/reswap", name: "Re-list & Cancel", description: "Cancel + re-list many tokens at once on objkt v6.2.", category: "artist", status: "ready" },
  ...
  { slug: "ops", href: "/ops", name: "Your Operations", description: "Your last 30 signed transactions, statuses + tzkt links.", category: "general", status: "ready" },
  { slug: "compare", href: "/compare", name: "Marketplace Spread", description: "An artist's listings broken down by marketplace.", category: "general", status: "ready" },
  ...
  // ── ADVANCED ──
  { slug: "mempool", href: "/mempool", name: "Network Status", description: "Network status — head + recent blocks.", category: "advanced", status: "ready" },
  { slug: "mempool-drop", href: "/mempool/drop", name: "Contract Watch", description: "Watch operations targeting a contract live.", category: "advanced", status: "ready" },
];
